...
import "./AgreeculturePropertiesandOthers.css";
import { API_URL } from '../../Api';

const fetchProperties = async () => {
  try {
    const response = await axios.get(`${API_URL}/agreecultureproperties/agriculture-properties`); // Use API_URL
...
const AgreeculturePropertiesandOthers = ({ filteredProperties }) => {
  ...
  return (
    <div className="all-properties-container">
      <h2 className="all-section-title">Featured Plot's</h2>
      <div className="all-properties-grid">
        {currentProperties.length > 0 ? (
          currentProperties.map((property) => (
            <div className="all-property-card" key={property._id}>
            <Link to={`/agreculture/${property._id}`} className="all-property-link">
                ...
                <div className="all-property-details">
                  ...
                  <div className="all-property-footer">
                    ...
                    <div className="all-property-info">
                      ...
                      <span>{property.facingDirection} Direction</span>
...
export default AgreeculturePropertiesandOthers;
